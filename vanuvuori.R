...
## Data and map crop ----
rr <- raster("data/vanuvuori/P5113D.tif")
...
## Map crop
# 62.7948794694578, 27.613955896375103
# 62.81331256698558, 27.645331030216383
long_range   = c(27.613955896375103, 27.645331030216383)
lat_range = c(62.7948794694578, 62.81331256698558)
...
base_map %>% 
  ...
  #                                   color="red",
  #                                   heightmap = zoom_mat)) %>% 
  plot_map(title_text = "Vanuvuori, Kuopio. Data: Maanmittauslaitos Maastotietokanta 03/2022 & OpenStreetMap.org", title_offset = c(15,15),
...
#### To Movie ----
if(interactive()) {
  filename_movie = "output/vanuvuori.mp4" #tempfile()
